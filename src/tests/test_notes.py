...
def test_create_note(test_app, monkeypatch):
    request_payload = {"title": "something", "description": "something else"}
    response_payload = {"id": 1, "title": "something",
    ...
    response = test_app.post("/notes/", content=json.dumps(request_payload))
